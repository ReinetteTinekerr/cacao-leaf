...
import 'package:cacao_leaf_detector/src/home/home_view.dart';
import 'package:cacao_leaf_detector/src/object_detector/image_label_view.dart';
            ...
            return MaterialPageRoute<void>(
              ...
              builder: (BuildContext context) {
                switch (routeSettings.name) {
                  ...
                  case ImageLabelView.routeName:
                    return const ImageLabelView();
                  case PictureDetailsView.routeName:
                    final args = routeSettings.arguments as Picture;
                    return PictureDetailsView(picture: args);
                  default:
                    return const HomeView();
                }
              },
